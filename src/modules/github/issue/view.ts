...
export default function view(data: Issue | undefined, userRequest: UserRequest, command: Command): ViewData | undefined {
    ...
    // Issues
        ...
        module: () => issues(userRequest, command.metadata.ownerName, command.metadata.name),
